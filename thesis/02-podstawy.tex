...
\section{Ewolucja kerneli - przegląd literatury}
...
Najprostsza z nich nosi nazwę \definicja{optymalizacji hiperparametrów (\english{Hyperparameter optimalization})}. Jest to określenie zbioru metod służących optymalizacji parametrów jakiegoś algorytmu. Do dokonania hiperoptymalizacji można posłużyć się jedną z metaheurystyk takich jak \definicja{Random Search} [\ref{url:hyperopt}], lub \definicja{Grid Search} \cite{practical_2003}.
