...
\title{Optymalizacja klasyfikatora SVM za pomocą programowania genetycznego}

\ppsupervisor{dr hab. Krzysztof Krawiec}
\ppyear{2012}      % Year of final submission (not graduation!)
...
\input{03-algorytm.tex}
\input{04-wyniki.tex}
\input{05-adhd.tex}
\input{06-podsumowanie.tex}
